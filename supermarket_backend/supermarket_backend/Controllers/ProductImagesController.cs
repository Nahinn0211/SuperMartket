...
namespace supermarket_backend.Controllers
{
    ...
    public class ProductImagesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ProductImage>>> GetProductImages()
        {
            ...
            return await _context.ProductImages.Where(pi => pi.RowDelete == 0).ToListAsync();
        }
        ...
        public async Task<ActionResult<ProductImage>> GetProductImage(int id)
        {
            ...
            var productImage = await _context.ProductImages.FirstOrDefaultAsync(pi => pi.ProductId == id && pi.RowDelete == 0);
        ...
        private async Task<string> SaveImageAndGetUrl(IFormFile file)
        {
            ...
            var uploadsFolder = @"C:\Users\lna02\OneDrive\Desktop\Project_Sem3\supermarket_frontend\src\assets\Images";
